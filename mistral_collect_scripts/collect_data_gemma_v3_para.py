...
parser.add_argument(
    '--dataset',
    choices=['ag_news', 'clinc150', 'news_topic', 'trec', 'snips', 'yahoo', 'tweet_eval_sent', 'yelp', 'mnli'],
    required=True,
    help="Choose a dataset from: 'ag_news', 'clinc150', 'news_topic', 'trec', 'snips', 'yahoo', 'tweet_eval_sent', 'yelp', 'mnli'"
)
...
path_to_seeds_csv = os.path.join('ICL_for_gen', 'datasets', dataset, f'collected_data_gemma{folder_addiction}', str(random_state), 'seeds_para.csv')
